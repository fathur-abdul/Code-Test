...
<head>
    ...
    <title>Vendor Makanan | @yield('title')</title>
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <span class="logo-mini"><b>Vendor</b></span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>Vendor </b>Food</span>
        </a>
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2024 <a href="{{ route('beranda') }}">Vendor Food</a>.</strong> All rights reserved.
    </footer>
</div>
<!-- ./wrapper -->
