    ...
    <div class="col-md-12 col-sm-12">
        ...
        <div class="box box-primary collapsed-box">
            ...
            <div class="box-body row">
                ...
                <div class="col-sm-6">
                    <div class="form-group has-feedback">
                        {!! Form::label('inp_berat_barang', 'berat') !!}
                        {!! Form::text('berat_barang',  null, ['id' => 'inp_berat_barang', 'class' => 'form-control']) !!}
                        <span class="help-block"><small>Silahkan masukan berat</small></span>
                    </div>
                    <div class="form-group has-feedback">
                ...
                <div class="modal-body row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <span class="help-block"><small>Silahkan pilih resto yang sesuai</small></span>
                        </div>
                        <div class="form-group has-feedback">
                    ...
                    <div class="col-md-6">
                        <div class="form-group has-feedback">
                            {!! Form::label('inp_edit_berat_barang', 'berat') !!}
                            {!! Form::text('berat_barang',  null, ['id' => 'inp_edit_berat_barang', 'class' => 'form-control']) !!}
                            <span class="help-block"><small>Silahkan masukan berat</small></span>
                        </div>
                        <div class="form-group has-feedback">
