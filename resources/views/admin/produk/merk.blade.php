            ...
            {!! Form::open(['route' => 'tambah_merk']) !!}
                ...
                <div class="box-body">
                    <div class="form-group has-feedback">
                        ...
                        <span class="help-block">Silahkan masukan nama restoran</span>
                    </div>
                    <div class="form-group has-feedback">
                        <button type="button" id="check_merk" class="btn btn-success btn-flat btn-block" class="form-control"><i class="fa fa-search fa-fw"></i> Check Nama resto</button>
                    </div>
                </div>
                <div class="box-footer">
                    <div class="form-group has-feedback">
                        <button type="button" id="simpan" name="simpan" value="true" class="btn btn-primary btn-flat btn-block form-control disabled">Simpan resto</button>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Edit Resotrain </h4>
            </div>
